(function () {
  ...
  function loadInsumosIntoSelects() {
    return InventarioApp.apiFetch("insumos.php").then(function (r) {
      ...
      list.forEach(function (i) {
        ...
        tr.innerHTML =
          ...
          "</td>" +
          "<td class=\"row-actions\"><button type=\"button\" class=\"danger\" data-del-ins=\"" +
          i.id +
          "\">Eliminar</button></td>";
    ...
    return InventarioApp.apiFetch(q).then(function (r) {
      ...
      r.relaciones.forEach(function (x) {
        ...
        tr.innerHTML =
          ...
          "</td>" +
          "<td class=\"row-actions\"><button type=\"button\" class=\"danger\" data-del-rel=\"" +
          x.id +
          "\">Quitar</button></td>";
  ...
  function refreshAll() {
    return loadCategorias().then(loadInsumosIntoSelects).then(loadRelaciones);
  }
  ...
  filtroRel.addEventListener("change", function () {
    loadRelaciones().catch(function (e) {
      showErr(e.message);
    });
  });
